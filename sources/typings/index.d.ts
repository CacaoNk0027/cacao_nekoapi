declare module "cacao_nekoapi" {
    ...
    export class SFW {
         ...
         */
        static action_1: {
            camp(): Promise<Rest1.UrlResult>
            cook(): Promise<Rest1.UrlResult>
            cuddle(): Promise<Rest1.UrlResult>
            cure(): Promise<Rest1.UrlResult>
            draw(): Promise<Rest1.UrlResult> 
            drive(): Promise<Rest1.UrlResult>
            eat(): Promise<Rest1.UrlResult> 
            feed(): Promise<Rest1.UrlResult>
            hug(): Promise<Rest1.UrlResult> 
            kickbut(): Promise<Rest1.UrlResult>
            kill(): Promise<Rest1.UrlResult> 
            kiss(): Promise<Rest1.UrlResult>
            pat(): Promise<Rest1.UrlResult>
            peek(): Promise<Rest1.UrlResult> 
            playing(): Promise<Rest1.UrlResult> 
            poke(): Promise<Rest1.UrlResult> 
            punch(): Promise<Rest1.UrlResult> 
            run(): Promise<Rest1.UrlResult> 
            sape(): Promise<Rest1.UrlResult> 
            shot(): Promise<Rest1.UrlResult> 
            shot(): Promise<Rest1.UrlResult> 
            sip(): Promise<Rest1.UrlResult> 
            slap(): Promise<Rest1.UrlResult> 
            sleep(): Promise<Rest1.UrlResult>
            spank(): Promise<Rest1.UrlResult> 
            stare(): Promise<Rest1.UrlResult>
            tickle(): Promise<Rest1.UrlResult> 
            travel(): Promise<Rest1.UrlResult>
         ...
         */
        static reaction_1: {
            angry(): Promise<Rest1.UrlResult> 
            baka(): Promise<Rest1.UrlResult>
            blush(): Promise<Rest1.UrlResult> 
            bored(): Promise<Rest1.UrlResult>
            cry(): Promise<Rest1.UrlResult> 
            dance(): Promise<Rest1.UrlResult>
            laught(): Promise<Rest1.UrlResult> 
            like(): Promise<Rest1.UrlResult>
            nervous(): Promise<Rest1.UrlResult> 
            pout(): Promise<Rest1.UrlResult>
            sad(): Promise<Rest1.UrlResult> 
            screen(): Promise<Rest1.UrlResult>
            smug(): Promise<Rest1.UrlResult> 
            teehee(): Promise<Rest1.UrlResult>
            think(): Promise<Rest1.UrlResult> 
            vomit(): Promise<Rest1.UrlResult>
            wink(): Promise<Rest1.UrlResult> 
            yandere(): Promise<Rest1.UrlResult>
        }
        /**
